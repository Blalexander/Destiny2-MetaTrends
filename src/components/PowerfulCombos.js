...
function PowerfulCombos(props) {
  ...
  return(
    <section className="powWeaponContainer">  
      <div id="powDuoContainer" onMouseOver={e => displayMouseOverStats(keysToAverage[1], keysToAverage[0], e)}>
      ...
      <div className="trioPowContainer" onMouseOver={e => displayMouseOverStatsTrio(trioKeysToAv[0], trioKeysToAv[1], trioKeysToAv[2], e)}>
